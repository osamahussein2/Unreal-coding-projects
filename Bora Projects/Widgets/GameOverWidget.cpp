...
UGameOverWidget::UGameOverWidget(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
    ...
    nextState = NextGameOverState::ENull;
}
...
void UGameOverWidget::NativeConstruct()
{
    ...
    RestartButton->OnClicked.AddDynamic(this, &UGameOverWidget::ResumeGame);
    QuitButton->OnClicked.AddDynamic(this, &UGameOverWidget::QuitToMain);

    RestartButton->OnPressed.AddDynamic(this, &UGameOverWidget::ResumeGame);
    QuitButton->OnPressed.AddDynamic(this, &UGameOverWidget::QuitToMain);

    RestartButton->OnHovered.AddDynamic(this, &UGameOverWidget::HoverOnPlayButton);
    QuitButton->OnHovered.AddDynamic(this, &UGameOverWidget::HoverOnQuitButton);
...
void UGameOverWidget::NativeTick(const FGeometry& Geometry, float DeltaTime)
{
    Super::NativeTick(Geometry, DeltaTime);

    switch (nextState)
    {
    case NextGameOverState::ENull:
        UpdateGameOverButtonState();

        break;

    case NextGameOverState::EResume:
...
void UGameOverWidget::UpdateGameOverButtonState()
{
...
void UGameOverWidget::HoverOnPlayButton()
{
    selectedButton = 0;
}

void UGameOverWidget::HoverOnQuitButton()
{
    selectedButton = 1;
}
...
void UGameOverWidget::ResumeGame()
{
    if (HideButtons)
    {
        ...
        nextState = NextGameOverState::EResume;

        RestartButton->OnClicked.RemoveDynamic(this, &UGameOverWidget::ResumeGame);
        QuitButton->OnClicked.RemoveDynamic(this, &UGameOverWidget::QuitToMain);

        RestartButton->OnPressed.RemoveDynamic(this, &UGameOverWidget::ResumeGame);
        QuitButton->OnPressed.RemoveDynamic(this, &UGameOverWidget::QuitToMain);

        RestartButton->OnHovered.RemoveDynamic(this, &UGameOverWidget::HoverOnPlayButton);
        QuitButton->OnHovered.RemoveDynamic(this, &UGameOverWidget::HoverOnQuitButton);
    }
}

void UGameOverWidget::QuitToMain()
{
    if (HideButtons)
    {
        if (QuitButton)
        ...
        nextState = NextGameOverState::EQuit;
...
void UGameOverWidget::PauseGameMusic(bool paused_)
{
