...
UENUM()
enum class NextGameWinState : uint8
{
	ENull,
	EResume,
	EQuit
 ...
 */
UCLASS()
class SHROOMJAM2025_API UGameWinWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UGameWinWidget(const FObjectInitializer& ObjectInitializer);
