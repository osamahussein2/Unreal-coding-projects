...
UENUM()
enum class NextPauseMenuState : uint8
{
	ENull,
	EResume,
	EQuit
 ...
 */
UCLASS()
class SHROOMJAM2025_API UPauseMenuWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	void UpdatePauseMenuButtonState();
