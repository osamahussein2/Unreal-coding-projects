...
#include "RhythmMinigameWidget.generated.h"
 ...
 */
UCLASS()
class BRACKEYSGAMEJAM_API URhythmMinigameWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	URhythmMinigameWidget(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* AText = nullptr;

	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* SText = nullptr;

	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* DText = nullptr;

	UPROPERTY(EditAnywhere, meta = (BindWidget))
	UTextBlock* FText = nullptr;
