...
UPickFourNervesWidget::UPickFourNervesWidget(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}

void UPickFourNervesWidget::NativeConstruct()
{
	...
	{
		restartSequenceButton->OnPressed.AddDynamic(this, &UPickFourNervesWidget::RestartNerveSequence);
	}
...
void UPickFourNervesWidget::NativeDestruct()
{
...
void UPickFourNervesWidget::RemoveBindedButtonDelegates()
{
	if (nerveOneButton)
	{
		nerveOneButton->OnPressed.RemoveDynamic(this, &UPickFourNervesWidget::NerveOneSelected);
	}

	if (nerveTwoButton)
	{
		nerveTwoButton->OnPressed.RemoveDynamic(this, &UPickFourNervesWidget::NerveTwoSelected);
	}

	if (nerveThreeButton)
	{
		nerveThreeButton->OnPressed.RemoveDynamic(this, &UPickFourNervesWidget::NerveThreeSelected);
	}

	if (nerveFourButton)
	{
		nerveFourButton->OnPressed.RemoveDynamic(this, &UPickFourNervesWidget::NerveFourSelected);
	}

	if (restartSequenceButton)
	{
		restartSequenceButton->OnPressed.RemoveDynamic(this, &UPickFourNervesWidget::RestartNerveSequence);
	}
}

void UPickFourNervesWidget::SetupNerveOneButtonImageDependingOnNerve()
{
	if (nerveOneButton)
	{
		...
		nerveOneButton->OnPressed.AddDynamic(this, &UPickFourNervesWidget::NerveOneSelected);

		SetupNerveTwoButtonImageDependingOnNerve();
	}
}

void UPickFourNervesWidget::SetupNerveTwoButtonImageDependingOnNerve()
{
	if (nerveTwoButton)
	{
		FButtonStyle buttonStyle;
		...
		nerveTwoButton->OnPressed.AddDynamic(this, &UPickFourNervesWidget::NerveTwoSelected);

		SetupNerveThreeButtonImageDependingOnNerve();
	}
}

void UPickFourNervesWidget::SetupNerveThreeButtonImageDependingOnNerve()
{
	if (nerveThreeButton)
	{
		FButtonStyle buttonStyle;
		...
		nerveThreeButton->OnPressed.AddDynamic(this, &UPickFourNervesWidget::NerveThreeSelected);

		SetupNerveFourButtonImageDependingOnNerve();
	}
}

void UPickFourNervesWidget::SetupNerveFourButtonImageDependingOnNerve()
{
	if (nerveFourButton)
	{
		FButtonStyle buttonStyle;
		...
		nerveFourButton->OnPressed.AddDynamic(this, &UPickFourNervesWidget::NerveFourSelected);
	}
}

void UPickFourNervesWidget::RestartNerveSequence()
{
...
void UPickFourNervesWidget::NerveOneSelected()
{
	if (AGoedWareCommunityGM* gameMode = Cast<AGoedWareCommunityGM>(UGameplayStatics::GetGameMode(GetWorld())))
	{
...
void UPickFourNervesWidget::NerveTwoSelected()
{
	if (AGoedWareCommunityGM* gameMode = Cast<AGoedWareCommunityGM>(UGameplayStatics::GetGameMode(GetWorld())))
	{
...
void UPickFourNervesWidget::NerveThreeSelected()
{
	if (AGoedWareCommunityGM* gameMode = Cast<AGoedWareCommunityGM>(UGameplayStatics::GetGameMode(GetWorld())))
	{
...
void UPickFourNervesWidget::NerveFourSelected()
{
	if (AGoedWareCommunityGM* gameMode = Cast<AGoedWareCommunityGM>(UGameplayStatics::GetGameMode(GetWorld())))
	{
