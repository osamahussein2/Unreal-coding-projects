...
#include "PickFourNervesWidget.generated.h"

/**
 * 
 */
UCLASS()
class GOEDWARECOMMUNITYJAM_API UPickFourNervesWidget : public UPickNerveWidget
{
	GENERATED_BODY()
	
public:
	UPickFourNervesWidget(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	/* 0 for first sequence press sound, 1 for second sequence press sound, 2 for third sequence press sound and 3 for fourth
	sequence press sound */
